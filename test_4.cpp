...
class worriers
{
    public:
        ...
        worriers(char id,int leftlife,int rank,int knowwho):color(id),wrank(rank),who(knowwho)
        {
            ...
            if(worrierweapons[2]) worrierweapons[2]=3;
            if(worrierweapons[0]) swordstrength=0.2*strength;
            bobaotime();
            if(id=='r') cout<<"red";
            else cout<<"blue";
...
class Home
{
    public:
        ...
        void produce(string id,worriers * p)
        {
            ...
            if(sumlife<lifearr[temploc]) return ;
            else 
            {
                if(id=="red") locred++;
                else locblue++;
...
int main()
{
    ...
    for(int i=1;i<=t;i++)
    {
        ...
        while(realt<=T)
        {
            ...
            if(gameoverred>=2||gameoverblue>=2) break;
            hours=realt/60;
            minutes=realt%60;
            if(minutes==0)
            {
            ...
            else if(minutes==40)
            {
                        ...
                        if(pred[i].place==j&&(pred[i].life>0||pred[i].shame))
                        {
                            for(int s=1;s<Bluehome.rank;s++)
                            {
                                if(pblue[s].place==j&&(pblue[s].life>0||pblue[s].shame))
                                {
                                    ...
                                    if(pred[i].shame&&pblue[s].shame) continue;
                                    ...
                                    if(pred[i].life<=0)
                                    {
                                        ...
                                        {
                                            pred[i].loyalty-=K;
                                            if(pred[i].shame) pblue[s].life+=0;
                                            else pblue[s].life+=redlife;
                                        }
                                        if(pblue[s].name=="wolf") 
                                        {
                                            for(int ww=0;ww<3;ww++)
                                            {
                                                if(pblue[s].worrierweapons[ww]==0)
                                                {
                                                    ...
                                                    if(ww==0) pblue[s].swordstrength=pred[i].swordstrength;
                                                }
                                            }
                                        }
                                        ...
                                        else if(cityflag[j]==0) cityflag[j]=1;
                                        else if(cityflag[j]==-3) cityflag[j]=-2;
                                        else cityflag[j]=1;
                                    }
                                    else if(pblue[s].life<=0)
                                    {
                                        ...
                                        {
                                            pblue[s].loyalty-=K;
                                            if(pblue[s].shame) pred[i].life+=0;
                                            else pred[i].life+=bluelife;
                                        }
                                        if(pred[i].name=="wolf") 
                                        {
                                            for(int ww=0;ww<3;ww++)
                                            {
                                                if(pred[i].worrierweapons[ww]==0)
                                                {
                                                    ...
                                                    if(ww==0) pred[i].swordstrength=pblue[s].swordstrength;
                                                }
                                            }
                                        }
                                        if(cityflag[j]<=-1||cityflag[j]==2)
                                    ...
                                    {
                                        if(pred[i].name=="dragon") pred[i].brave-=0.2;
                                        if(pblue[s].name=="dragon") pblue[s].brave-=0.2;
                                        ...
                                        if(cityflag[j]==-2) cityflag[j]=-3;
                                        else if(cityflag[j]==2) cityflag[j]=3;
                                        else if(abs(cityflag[j])<=1) cityflag[j]=0;
                                    }
                                }
                            }
                        }
                ...
                {
                    if(Redhome.sumlife<8) break;
                    pred[redwin[p]].life+=8;
                    Redhome.sumlife-=8;
                }
                for(int p=0;p<bluerecord;p++)
                {
                    if(Bluehome.sumlife<8) break;
                ...
                */
                for(int s=Redhome.rank-1;s>=1;s--)
                {
                    if(pred[s].life>0)
                    {
                        ...
                        if(pred[s].swordstrength==0) pred[s].worrierweapons[0]=0;
                        for(int i=2;i>=0;i--)
                        {
                            if(pred[s].worrierweapons[i])
                            {
                                flag++;
                                if(i==2) cout<<"arrow("<<pred[s].worrierweapons[2]<<")";
                                else if(flag>1&&i==1) cout<<",bomb";
                                else if(i==1) cout<<"bomb";
                                else if(flag>1&&i==0) cout<<",sword("<<pred[s].swordstrength<<")";
                                else cout<<"sword("<<pred[s].swordstrength<<")";
                            }
                        }
                        if(flag==0) cout<<"no weapon";
                        cout<<endl;
                    }
                }
                for(int s=1;s<Bluehome.rank;s++)
                {
                    ...
                    if(pblue[s].life>0)
                    {
                        ...
                        if(pblue[s].swordstrength==0) pblue[s].worrierweapons[0]=0;
                        for(int i=2;i>=0;i--)
                        {
                            if(pblue[s].worrierweapons[i])
                            {
                                flag++;
                                if(i==2) cout<<"arrow("<<pblue[s].worrierweapons[2]<<")";
                                else if(flag>1&&i==1) cout<<",bomb";
                                else if(i==1) cout<<"bomb";
                                else if(flag>1&&i==0) cout<<",sword("<<pblue[s].swordstrength<<")";
                                else cout<<"sword("<<pblue[s].swordstrength<<")";
                            }
                        }
                        if(flag==0) cout<<"no weapon";
                        cout<<endl;
