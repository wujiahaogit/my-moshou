            ...
            if (realbeat(aweapon))
            {
                ...
                for (step = 1; step <= 10; step++)
                {
                    ...
                    if (aweapon[(sta + step) % 10] > 2)
                    {
                        ...
                        if (aweapon[(sta + step) % 10] == 3)
                            aweapon[(sta + step) % 10] = 0;
                        else
                            aweapon[(sta + step) % 10] = 3;
                        sta = (sta + step) % 10;
                        break;
                    }
                }
            ...
            if (a.life > 0 && b.life > 0 && realbeat(bweapon))
            {
                ...
                for (step = 1; step <= 10; step++)
                {
                    ...
                    if (bweapon[(stb + step) % 10] > 2)
                    {
                        ...
                        if (bweapon[(stb + step) % 10] == 3)
                            bweapon[(stb + step) % 10] = 0;
                        else
                            bweapon[(stb + step) % 10] = 3;
                        flag = 1;
                        stb = (stb + step) % 10;
                        break;
                    }
                            ...
                            for (int s = 1; s <= Bluehome.rank; s++)
                            {
                                if (pblue[s].life > 0 && pblue[s].place == j && pblue[s].name != "wolf")
                                {
                                    ...
                                    else
                                    {
                                        for (int w = 0; w < 10; w++)
                                        {
                                            if (pblue[s].weapon2[w])
                                                grabweapon = 2;
                                        }
                                        int weapon2to2 = 0, weapon2to1 = 0;
                                        for (int i = 0; i < 10; i++)
                                        {
                                            if (pblue[s].weapon2[i] == 2)
                                                weapon2to2++;
                                            else if (pblue[s].weapon2[i])
                                                weapon2to1++;
                                        }
                                        ...
                                        for (int i = 0; i < 10; i++)
                                        {
                                            if (i < weapon2to1)
                                                pblue[s].weapon2[i] = 2;
                                            else if (i < weapon2to2 + weapon2to1)
                                                pblue[s].weapon2[i] = 1;
                                            else
                                                pblue[s].weapon2[i] = 0;
                                        }
                            ...
                            for (int s = 1; s <= Redhome.rank; s++)
                            {
                                if (pred[s].life > 0 && pred[s].place == j && pred[s].name != "wolf")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        for (int i = 0; i < 10; i++)
                                        {
                                            if (pred[s].weapon2[i] == 2)
                                                weapon2to2++;
                                            else if (pred[s].weapon2[i])
                                                weapon2to1++;
                                        }
                                        int loseto2 = 0, loseto1 = 0;
